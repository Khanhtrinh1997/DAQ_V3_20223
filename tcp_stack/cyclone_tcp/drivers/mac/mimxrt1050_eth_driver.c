...
void mimxrt1050EthInitGpio(NetInterface *interface)
{
   ...
   pllConfig.enableClkOutput25M = true;//false 
   ...
   IOMUXC_SetPinMux(IOMUXC_GPIO_B1_14_ENET_MDC, 0);//thanhcm3--IOMUXC_GPIO_EMC_40_ENET_MDC,--IOMUXC_GPIO_B1_14_ENET_MDC,--IOMUXC_GPIO_AD_B1_04_ENET_MDC

   //Set GPIO_EMC_40 pad properties
   IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_14_ENET_MDC,//thanhcm3--IOMUXC_GPIO_EMC_40_ENET_MDC,--IOMUXC_GPIO_B1_14_ENET_MDC,--IOMUXC_GPIO_AD_B1_04_ENET_MDC
      IOMUXC_SW_PAD_CTL_PAD_HYS(0) |
      IOMUXC_SW_PAD_CTL_PAD_PUS(0) |
      IOMUXC_SW_PAD_CTL_PAD_PUE(0) |
      IOMUXC_SW_PAD_CTL_PAD_PKE(0) |
   ...
   IOMUXC_SetPinMux(IOMUXC_GPIO_B1_15_ENET_MDIO, 0);//thanhcm3--IOMUXC_GPIO_EMC_41_ENET_MDIO

   //Set GPIO_EMC_41 pad properties
   IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_15_ENET_MDIO,//thanhcm3--IOMUXC_GPIO_EMC_41_ENET_MDIO
      IOMUXC_SW_PAD_CTL_PAD_HYS(0) |
   ...
   if(system_flag_struct.eth_type == DP83825){
      ...
      IOMUXC_SetPinMux(IOMUXC_GPIO_B0_13_GPIO2_IO13, 0);//IOMUXC_GPIO_B0_13_GPIO2_IO13--IOMUXC_GPIO_AD_B0_09_GPIO1_IO09

     //Set GPIO_AD_B0_09 pad properties
     IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_13_GPIO2_IO13,////IOMUXC_GPIO_B0_13_GPIO2_IO13--IOMUXC_GPIO_AD_B0_09_GPIO1_IO09
      IOMUXC_SW_PAD_CTL_PAD_HYS(0) |
      IOMUXC_SW_PAD_CTL_PAD_PUS(0) |
      IOMUXC_SW_PAD_CTL_PAD_PUE(0) |
      IOMUXC_SW_PAD_CTL_PAD_PKE(0) |
     ...
     //Configure GPIO_AD_B0_09 pin as GPIO1_IO09
     IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_09_GPIO1_IO09, 0);//IOMUXC_GPIO_B0_13_GPIO2_IO13--IOMUXC_GPIO_AD_B0_09_GPIO1_IO09

     //Set GPIO_AD_B0_09 pad properties
     IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_09_GPIO1_IO09,////IOMUXC_GPIO_B0_13_GPIO2_IO13--IOMUXC_GPIO_AD_B0_09_GPIO1_IO09
      IOMUXC_SW_PAD_CTL_PAD_HYS(0) |
      IOMUXC_SW_PAD_CTL_PAD_PUS(0) |
      IOMUXC_SW_PAD_CTL_PAD_PUE(0) |
      IOMUXC_SW_PAD_CTL_PAD_PKE(0) |
   ...
   if(system_flag_struct.eth_type == DP83825){
     ...
     GPIO_PinInit(GPIO2, 13, &pinConfig);//GPIO1, 9
   }else if(system_flag_struct.eth_type == LAN8720){
     //Configure ENET_RST as an output
     pinConfig.direction = kGPIO_DigitalOutput;
     pinConfig.outputLogic = 0;
     pinConfig.interruptMode = kGPIO_NoIntmode;
     GPIO_PinInit(GPIO1, 9, &pinConfig);//GPIO1, 9
   }
   ...
   if(system_flag_struct.eth_type == DP83825){
     ...
     GPIO_PinWrite(GPIO2, 13, 0);//GPIO1, 9
     sleep(10);
     GPIO_PinWrite(GPIO2, 13, 1);//GPIO1, 9
     sleep(10);
   }else if(system_flag_struct.eth_type == LAN8720){
     //Reset PHY transceiver (hard reset)
     GPIO_PinWrite(GPIO1, 9, 0);//GPIO1, 9
     sleep(10);
     GPIO_PinWrite(GPIO1, 9, 1);//GPIO1, 9
     sleep(10);
   }
}
